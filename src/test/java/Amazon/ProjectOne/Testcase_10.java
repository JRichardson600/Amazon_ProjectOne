//TC-10-Test updating item quantities and removing from the product pages
...
public class Testcase_10 extends Launch_Quit {
	...
	public void EditCartPage_Testcase_10() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		Amz_B2C_Pre_Cart_2_ProceedToPayment_page_9 a5=new Amz_B2C_Pre_Cart_2_ProceedToPayment_page_9(driver);
		a5.product1_dd_values();
		Reporter.log("Changing the product quantities in the Cart is Done");
		
		a5.product2_delete();
		a5.CheckIfProductisDeletedorNot();
		Reporter.log("Deleting the product in the Cart is Done");
